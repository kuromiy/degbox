...
**エンドポイント**: `src/main/apis/authors/create.ts`（新規作成予定）
...
- **ページコンポーネント**: `src/renderer/pages/author.create.page.tsx`（新規作成）
- **フォームコンポーネント**: `features/author/ui/components/author.form.tsx`（新規作成）
  - 作者登録画面と作者編集画面で共有
